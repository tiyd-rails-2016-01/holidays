...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { celebrated_on: @holiday.celebrated_on, name: @holiday.name, origin: @holiday.origin }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { celebrated_on: @holiday.celebrated_on, name: @holiday.name, origin: @holiday.origin }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
